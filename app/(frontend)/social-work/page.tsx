 ...
 * edited in the dashboard at Content → Website pages. The albums and films it
 * carries are added in Content → Social Work. Until the page is imported there,
 * it renders the copy it ships with, in lib/page-defaults.ts.
 */
export const generateMetadata = () => routeMetadata("/social-work");

export default function SocialWorkPage() {
  return <RoutePage path="/social-work" />;
}
