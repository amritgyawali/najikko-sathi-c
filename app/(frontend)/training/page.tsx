...
export default async function TrainingPage() {
  ...
  return <>
    <PageHero eyebrow="Training & capacity building" title="Learn the skills behind meaningful media." description="Practical programs for people who write, report, film, design, and manage digital communication. Start with the skill you want to build." path="/training" label="Training" category={category}><Link className="hero-cta" href="/contact?service=Training">Ask about a program <ArrowRight aria-hidden="true" /></Link></PageHero>
    ...
    <section className="content-section related-section"><div className="site-container"><SectionHeading kicker="Choose your direction" title="Five programs. Practical possibilities." /><ServiceCards services={services.filter((service) => service.category.id === "training")} /></div></section>
